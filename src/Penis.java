...
public static void main(String[] args) {
		...
		for (int n=0;n<360; n+=30) {
			...
			drawShaft(STARTING_POSITION_X, STARTING_POSITION_Y, 6, 320, n);
		}
		while(true) {
		...
		if(seconds1!=secondes) {
			...
			fastdrawDisc(135, STARTING_POSITION_X, STARTING_POSITION_Y);
		
		drawPenis(STARTING_POSITION_X, STARTING_POSITION_Y, Hour, Color.red, 28, 100, 28);
		drawPenis(STARTING_POSITION_X, STARTING_POSITION_Y, Minute, Color.yellow, 24, 120, 24);
		if (secondes==0){
		drawPenis(STARTING_POSITION_X, STARTING_POSITION_Y, secondes*6, Color.green, 14, 125, 16);}

		drawPenis(STARTING_POSITION_X, STARTING_POSITION_Y, secondes*6, Color.green, 14, secondes+65, 16);

		}
		seconds1=secondes;
				//display.setColor(Color.white);
		
		//drawPenis(STARTING_POSITION_X, STARTING_POSITION_Y, secondes*6, Color.black, 14, secondes+65, 16);
